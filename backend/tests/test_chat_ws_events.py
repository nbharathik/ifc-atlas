...
used to be silently dropped (error / model_fallback / budget_warning) and the
post-done checkpoint isolation, using TestClient websockets with stream_chat
mocked - no real LLM or IFC work.
"""
