...
import { parseSearchQuery } from '../../services/ifc/searchQuery';
import type { ParsedQuery } from '../../services/ifc/searchQuery';
import {
  ENRICHMENT_ELEMENT_CAP,
  baseIndexSize,
  buildEnrichment,
  ensureEnrichmentModel,
  getEnrichmentStatus,
  searchModelParsed,
  subscribeEnrichment,
} from '../../services/ifc/searchEnrichment';
import {
